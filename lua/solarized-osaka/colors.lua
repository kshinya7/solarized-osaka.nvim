...
M.default = {
  ...
  base4 = hsl(0, 0, 100),
  yellow = hsl(48, 54, 47),
  yellow100 = hsl(48, 54, 80),
  yellow300 = hsl(48, 54, 64),
  yellow500 = hsl(48, 54, 47),
  yellow700 = hsl(54, 36, 30),
  yellow900 = hsl(47, 62, 15),
  orange = hsl(16, 59, 42),
  orange100 = hsl(16, 59, 78),
  orange300 = hsl(16, 59, 60),
  orange500 = hsl(16, 59, 42),
  orange700 = hsl(16, 59, 28),
  orange900 = hsl(16, 59, 13),
  red = hsl(359, 57, 42),
  red100 = hsl(359, 57, 80),
  red300 = hsl(359, 57, 62),
  red500 = hsl(359, 57, 42),
  red700 = hsl(359, 57, 28),
  red900 = hsl(359, 57, 14),
  magenta = hsl(334, 61, 51),
  magenta100 = hsl(334, 100, 73),
  magenta300 = hsl(334, 86, 64),
  magenta500 = hsl(334, 61, 51),
  magenta700 = hsl(334, 61, 41),
  magenta900 = hsl(334, 65, 20),
  violet = hsl(239, 44, 60),
  violet100 = hsl(239, 100, 90),
  violet300 = hsl(239, 69, 77),
  violet500 = hsl(239, 44, 60),
  violet700 = hsl(239, 44, 50),
  violet900 = hsl(239, 42, 25),
  blue = hsl(210, 43, 48),
  blue100 = hsl(210, 43, 82),
  blue300 = hsl(210, 43, 65),
  blue500 = hsl(210, 43, 48),
  blue700 = hsl(210, 43, 32),
  blue900 = hsl(210, 43, 16),
  cyan = hsl(178, 26, 45),
  cyan100 = hsl(178, 26, 80),
  cyan300 = hsl(178, 26, 63),
  cyan500 = hsl(178, 26, 45),
  cyan700 = hsl(178, 26, 30),
  cyan900 = hsl(178, 26, 15),
  green = hsl(72, 38, 43),
  green100 = hsl(72, 38, 78),
  green300 = hsl(72, 38, 61),
  green500 = hsl(72, 38, 43),
  green700 = hsl(72, 38, 28),
  green800 = hsl(72, 38, 21),
  green900 = hsl(72, 38, 14),
