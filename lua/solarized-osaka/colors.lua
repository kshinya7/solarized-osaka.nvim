...
M.default = {
  ...
  base4 = hsl(0, 0, 100),
  yellow = hsl(48, 54, 52),
  yellow100 = hsl(48, 54, 85),
  yellow300 = hsl(48, 54, 69),
  yellow500 = hsl(48, 54, 52),
  yellow700 = hsl(54, 36, 35),
  yellow900 = hsl(47, 62, 20),
  orange = hsl(16, 59, 47),
  orange100 = hsl(16, 59, 83),
  orange300 = hsl(16, 59, 65),
  orange500 = hsl(16, 59, 47),
  orange700 = hsl(16, 59, 33),
  orange900 = hsl(16, 59, 18),
  red = hsl(359, 57, 47),
  red100 = hsl(359, 57, 85),
  red300 = hsl(359, 57, 67),
  red500 = hsl(359, 57, 47),
  red700 = hsl(359, 57, 33),
  red900 = hsl(359, 57, 19),
  ...
  violet = hsl(239, 44, 65),
  violet100 = hsl(239, 100, 95),
  violet300 = hsl(239, 69, 82),
  violet500 = hsl(239, 44, 65),
  violet700 = hsl(239, 44, 55),
  violet900 = hsl(239, 42, 30),
  blue = hsl(210, 43, 53),
  blue100 = hsl(210, 43, 87),
  blue300 = hsl(210, 43, 70),
  blue500 = hsl(210, 43, 53),
  blue700 = hsl(210, 43, 37),
  blue900 = hsl(210, 43, 21),
  cyan = hsl(178, 26, 50),
  cyan100 = hsl(178, 26, 85),
  cyan300 = hsl(178, 26, 68),
  cyan500 = hsl(178, 26, 50),
  cyan700 = hsl(178, 26, 35),
  cyan900 = hsl(178, 26, 20),
  green = hsl(72, 38, 48),
  green100 = hsl(72, 38, 83),
  green300 = hsl(72, 38, 66),
  green500 = hsl(72, 38, 48),
  green700 = hsl(72, 38, 33),
  green800 = hsl(72, 38, 26),
  green900 = hsl(72, 38, 19),
